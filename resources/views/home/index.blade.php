...
<section class="contatos">
  ...
  <div class="localizacao d-flex flex-column justify-content-center align-items-center px-2 pt-5 pb-3">

    <h2 class="localizacao-titulo fw-bold pb-3">Localização</h2>
  ...
  <div class="contatos-conteudo d-flex flex-column justify-content-center align-items-center ">
    ...
    <p class="contatos-telefones"> <i class="fa-brands fa-whatsapp"></i> (63) 98120-0001 <br>
